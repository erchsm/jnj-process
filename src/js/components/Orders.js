	...
	render() {
        return (
            <div className="column is-two-thirds top">
                ...
                <h1 className="title is-1">Design Systems</h1>
                <h3 className="title is-3">Resources</h3>

                <div className="tile is-ancestor">
                    <a href="https://vmware.github.io/clarity/" className="tile is-parent" target="_blank">
                        <div className="tile is-child card">
                            <img src="/assets/img/clarity.jpg"></img>
                            <h3 className="title is-3 is-spaced">Clarity</h3>
                            <p className="subtitle is-5">UX guide, HTML/CSS framework, and Angular 2 components</p>
                            <br />
